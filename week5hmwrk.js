...
const phoneNum = users.map(user => user.phone);
console.log(phoneNum);


/*create and print a list of website, email pairs*/

const websiteEmail = users.map(user => `${user.website}: ${user.email}` );
...
/*find user 9's incomplete task*/
 const incompleteTasks = user9Tasks.filter(task => task.completed === false);
 console.log(incompleteTasks.length);

/*create a list of user 5 posts*/
const user5Posts = posts.filter (posts => posts.userId === 5);
